...
<tileset version="1.10" tiledversion="1.11.2" name="32x32_WaterPlants_7" tilewidth="16" tileheight="16" tilecount="24" columns="12">
 <image source="textures/Animation/Water_Plants/Colour1/32x32_WaterPlants_7.png" width="192" height="32"/>
 <tile id="12">
  <animation>
