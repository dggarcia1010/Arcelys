...
<tileset version="1.10" tiledversion="1.11.2" name="Smoke_animation" tilewidth="16" tileheight="16" tilecount="54" columns="18">
 <image source="textures/Smoke_animation.png" width="288" height="48" />
 <tile id="0">
  <animation>
